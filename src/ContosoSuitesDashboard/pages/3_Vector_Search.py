    ...
    if st.button("Submit"):
        with st.spinner("Performing vector search..."):
            if query:
                ...
                # Exercise 3 Task 3
                # TODO #4: Get the vectorized query text by calling handle_query_vectorization.
                query_vector = handle_query_vectorization(query)

                # Perform the vector search.
                # Exercise 3 Task 3
                # TODO #5: Get the vector search results by calling handle_vector_search.
                ...
                if vector_search_results.status_code == 200:
                    ...
                    st.error(
                        f"Error: {vector_search_results.status_code} - {vector_search_results.text}"
                    )
            else:
