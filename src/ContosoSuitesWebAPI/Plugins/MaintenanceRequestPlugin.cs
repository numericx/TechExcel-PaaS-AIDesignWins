...
// Exercise 5 Task 2 
// TODO #5: Add a library references support Semantic Kernel.
...
namespace ContosoSuitesWebAPI.Plugins
{
    ...
    public class MaintenanceRequestPlugin(CosmosClient cosmosClient)
    {
        ...
        // Exercise 5 Task 2 
        // TODO #6: Add KernelFunction and Description descriptors to the function.
        ...
        // Exercise 5 Task 2 
        // TODO #7: Add Kernel as the first parameter to the function.
        /// <summary>
        ...
        public Task<MaintenanceRequest> CreateMaintenanceRequest(Kernel kernel, int HotelId, string Hotel, string Details, int? RoomNumber, string? location)
        {
            try
            {
